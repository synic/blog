...
---
<!-- summary -->
I like TextPattern a lot, but it doesn’t seem to work well for programmers.
I couldn’t ever find a syntax highlighting plugin (that worked) for it, and even
when I did figure out a way to post code TextPattern would try to format it.

So, I finally had a reason to learn Django, and here is the product.
I even implemented my own syntax highlighting filter
(<a href='http://stderr.ws'>Josh Simpson’s</a> idea to do this is actually what
...
There’s still a lot of work to do on it, but I’ll get the old posts migrated
soon.
