...
Gmail so you can easily send and receive encrypted email! I've been using it for
this feature alone as soon as I found out about it's existence. Now there really
is no reason to use an IMAP client in my opinion.<br><br> So what's so annoying
...
an intrusive dialog asking if you want to upgrade. That <i>could</i> be
...
again when you restart. <br><br>If you're like me, you're fairly annoyed at this
...
recommend that you don't. If you click "Ok", you're prompted with <i>another</i>
...
want to; who wants potential security issues?<br><br> Ok, I realize that
...
to want to not use it at all. <br><br> Here are my suggestions to the authors of
