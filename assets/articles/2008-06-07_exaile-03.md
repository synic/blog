...
add things to in the future.<br><br> As of this writing, you can create a
...
default player.<br><br> However: none of this can be done using a gui yet. This
...
you should be too. Exaile 0.3 will be pretty awesome.<br><br> P.S. Thanks Aren
:)
