...
Don't worry, we're still here, and still hard at work. I thought I would give an
update since it's been quite a while since the last one.
<!-- end-summary -->
...
off, 0.3 will have a *lot* of other features that 0.2.14 never had.
...
clicking on the appropriate star in the playlist, much like Rhythmbox does. I've
tried to do this myself a few times and have never had much success. Gone, now,
is the old rating dropdown, which leaves us with a lot of free space in the
upper right of the UI. We haven't even discussed what might go there, but
...
Anyway, that's it for today. Things are moving along quite nicely. Hopefully we
can make our August goal.
