...
func BaseLayout(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if !isPartial(ctx) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<title>Adam's Blog</title><link rel=\"icon\" href=\"data:,\"></head><body id=\"body\" class=\"justify-center text-xl bg-gray-900 md:p-4 md:text-xl lg:p-9 lg:text-2xl xl:px-12 xl:pt-8 text-slate-300\"><div class=\"bg-gray-800 shadow-xl md:rounded-xl\">")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
