	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if pd.Page <= 1 {
				if pd.Tag != "" || pd.Search != "" {
					...
					if pd.Tag != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 27, Col: 19}
						}
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 29, Col: 33}
						}
			...
			for i, a := range pd.Items {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 38, Col: 43}
				}
				...
				templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(string(articleURL(a)))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 39, Col: 35}
				}
				...
				var templ_7745c5c3_Var7 templ.SafeURL = articleURL(a)
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 1, Col: 0}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 53, Col: 17}
				}
				...
				if a.IsPublished {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 58, Col: 56}
					}
				...
				templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(string(articleURL(a)))
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/component/articles.templ`, Line: 70, Col: 36}
				}
				...
				var templ_7745c5c3_Var13 templ.SafeURL = articleURL(a)
